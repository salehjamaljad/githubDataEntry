...
def breadfastInvoices():
    ...
    categories_dict = {
                "فاكهه": [
                    ...
                    "خوخ سكرى", "عنب اسود 1ك", "عنب ايرلي سويت ابيض 1ك", "بطيخ", "خوخ محلي 1كجم","تفاح مشكل 1كجم"
                ],
                "خضار": [
                ...
                "جاهز": [
                    ...
                    "رمان مفرط 350 جم", "قرنبيط 500 جرام", "خضار  مشكل فريش 350 جرام", "ملوخية جاهزة350جم","باذنجان للحشو 350جم"
                ],
                "اعشاب": [
                    ...
                    "كزبرة معبأ", "كرفس فرنساوي 250 جرام", "ملوخية جاهزة500جم", "جرجير معبأ"
                ]}
